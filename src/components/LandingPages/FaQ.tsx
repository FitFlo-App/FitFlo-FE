...
const faqs = [
  ...
  },
  {
    ...
    answer:
      `You can reach our customer support team through the in-app chat or email us at ${import.meta.env.VITE_CONTACT_EMAIL || "contact@fitflo.faizath.com"}. We're here to help 24/7!`,
  },
];
